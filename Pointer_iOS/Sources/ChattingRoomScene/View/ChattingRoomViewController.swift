...
//MARK: - set NavigationBar
    private func setupNavigationController() {
        ...
        let backButton = UIBarButtonItem.getPointerBarButton(withIconimage: backImage, size: 45, target: self, color: UIColor.navBackColor, handler: #selector(handleBackButtonTaped))
        ...
        let menuButton = UIBarButtonItem.getPointerBarButton(withIconimage: menuImage, size: 45, target: self, color: UIColor.navBackColor, handler: #selector(handleMenuButtonTapped))
